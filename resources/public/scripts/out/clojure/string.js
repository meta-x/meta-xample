...
{{
var G__10925 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10925;
continue;
}
} else
...
{var pred__10929 = cljs.core._EQ_;var expr__10930 = limit;if(cljs.core.truth_(pred__10929.call(null,1,expr__10930)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10929.call(null,2,expr__10930)))
...
var G__10932 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10933 = (limit__$1 - 1);
var G__10934 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10932;
limit__$1 = G__10933;
parts = G__10934;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10936 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10936))
{var replacement_10937 = temp__4124__auto___10936;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10937)));
} else
{buffer.append(ch);
}
{
