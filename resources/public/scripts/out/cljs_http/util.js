...
*/
cljs_http.util.build_url = (function build_url(p__10916){var map__10919 = p__10916;var map__10919__$1 = ((cljs.core.seq_QMARK_.call(null,map__10919))?cljs.core.apply.call(null,cljs.core.hash_map,map__10919):map__10919);var query_string = cljs.core.get.call(null,map__10919__$1,new cljs.core.Keyword(null,"query-string","query-string",1183691816));var uri = cljs.core.get.call(null,map__10919__$1,new cljs.core.Keyword(null,"uri","uri",1014020318));var server_port = cljs.core.get.call(null,map__10919__$1,new cljs.core.Keyword(null,"server-port","server-port",4503998525));var server_name = cljs.core.get.call(null,map__10919__$1,new cljs.core.Keyword(null,"server-name","server-name",4503925319));var scheme = cljs.core.get.call(null,map__10919__$1,new cljs.core.Keyword(null,"scheme","scheme",4400883991));return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__10920 = (new goog.Uri());G__10920.setScheme(cljs.core.name.call(null,(function (){var or__3541__auto__ = scheme;if(cljs.core.truth_(or__3541__auto__))
{return or__3541__auto__;
} else
{return new cljs.core.Keyword(null,"http","http",1017117690);
}
})()));
G__10920.setDomain(server_name);
G__10920.setPort(server_port);
G__10920.setPath(uri);
G__10920.setQuery(query_string,true);
return G__10920;
})()));
});
/**
...
cljs_http.util.parse_headers = (function parse_headers(headers){return cljs.core.reduce.call(null,(function (p1__10922_SHARP_,p2__10921_SHARP_){var vec__10924 = clojure.string.split.call(null,p2__10921_SHARP_,/:\s+/);var k = cljs.core.nth.call(null,vec__10924,0,null);var v = cljs.core.nth.call(null,vec__10924,1,null);if(cljs.core.truth_((function (){var or__3541__auto__ = clojure.string.blank_QMARK_.call(null,k);if(cljs.core.truth_(or__3541__auto__))
{return or__3541__auto__;
} else
...
{return cljs.core.assoc.call(null,p1__10922_SHARP_,clojure.string.lower_case.call(null,k),v);
}
}),cljs.core.PersistentArrayMap.EMPTY,clojure.string.split.call(null,(function (){var or__3541__auto__ = headers;if(cljs.core.truth_(or__3541__auto__))
{return or__3541__auto__;
} else
{return "";
}
