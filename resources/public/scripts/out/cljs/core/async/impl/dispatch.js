...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_5619 = 0;while(true){
var m_5620 = cljs.core.async.impl.dispatch.tasks.pop();if((m_5620 == null))
{} else
{m_5620.call(null);
if((count_5619 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__5621 = (count_5619 + 1);
count_5619 = G__5621;
continue;
}
} else
