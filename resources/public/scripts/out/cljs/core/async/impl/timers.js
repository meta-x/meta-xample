...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_6888 = 0;while(true){
if((i_6888 < arr.length))
{(arr[i_6888] = null);
{
...
{var i_6895 = (self__.level + 1);while(true){
if((i_6895 <= (new_level + 1)))
{(update[i_6895] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_6897 = 0;while(true){
if((i_6897 <= self__.level))
{var links_6898 = (update[i_6897]).forward;if(((links_6898[i_6897]) === x__$1))
{(links_6898[i_6897] = (x__$1.forward[i_6897]));
{
var G__6899 = (i_6897 + 1);
i_6897 = G__6899;
continue;
}
} else
{{
var G__6900 = (i_6897 + 1);
i_6897 = G__6900;
continue;
}
}
